...
_PLANS: dict[str, dict[str, list[tuple[str, str]]]] = {
    ...
    "criminal": {
        "en": [
            ("Right now", "Stay silent except to ask for a lawyer (Article 12)."),
            ("Within 24 hours", "Demand to be informed of charges in a language you understand."),
            ("Within 48 hours", "Insist on access to a lawyer; refuse to sign anything without one."),
            ("This week", "Document any mistreatment — Article 13 voids confessions under duress."),
        ],
        "ar": [
            ("الآن", "التزم الصمت ولا تتكلم إلا لطلب محامٍ (المادة 12)."),
            ("خلال 24 ساعة", "اطلب إبلاغك بالتهم بلغة تفهمها."),
            ("خلال 48 ساعة", "أصرّ على لقاء محامٍ ولا توقّع أي ورقة بدونه."),
            ("هذا الأسبوع", "وثّق أي سوء معاملة — المادة 13 تُبطل الاعترافات تحت الإكراه."),
        ],
    },
    "labor": {
        "en": [
